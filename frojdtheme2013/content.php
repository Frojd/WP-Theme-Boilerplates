...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			<?php edit_post_link( __( 'Edit', get_translation_domain() ), '<span class="edit-link">', '</span>' ); ?>
		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
	...
	<footer class="entry-meta">
		<?php if ( comments_open() && ! is_single() ) : ?>
			<div class="comments-link">
				<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a comment', get_translation_domain() ) . '</span>', __( 'One comment so far', get_translation_domain() ), __( 'View all % comments', get_translation_domain() ) ); ?>
			</div><!-- .comments-link -->
